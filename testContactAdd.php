...
var image = $('<img />').loadImg('http://newsletter.sideshowtoy.com/public/?q=direct_add&fn=Public_DirectAddForm&id=bgvbxmcazgvrpqnzivqocovoiuswbja&email=matthew.boisjolie@sideshowcollectibles.com').done(function() {
...
var otherImage = $('<img />').loadImg('http://newsletter11.sideshowtoy.com/public/?q=direct_add&fn=Public_DirectAddForm&id=bgvbxmcazgvrpqnzivqocovoiuswbja&email=matthew.boisjolie@sideshowcollectibles.com').done(function() {
    $('body').append(this).append($('<span />').text(this.attr('src') + ' found!').css('color', 'green'));
}).fail(function(){
    $('body').append($('<p />').html(this.attr('src') + ' not found').css('color', 'red'));
		var data = new Array();
        $.ajax({
          ...
          type: "GET",
          data: {request: 'http://newsletter11.sideshowtoy.com/public/?q=direct_add&fn=Public_DirectAddForm&id=bgvbxmcazgvrpqnzivqocovoiuswbja&email=matthew.boisjolie@sideshowcollectibles.com'}
        }).done(function(data) {
				alert(data);
		});
});
